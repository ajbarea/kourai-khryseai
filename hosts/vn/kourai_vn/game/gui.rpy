...
define gui.idle_small_color = '#7A6846'

## The color that is used for buttons and bars that are hovered.
define gui.hover_color = '#F5C842'
...
define gui.insensitive_color = '#4A3A2A7F'

## Colors used for the portions of bars that are not filled in. These are not
## used directly, but are used when re-generating bar image files.
define gui.muted_color = '#3A2800'
...
define gui.choice_button_text_idle_color = '#9A8866'
define gui.choice_button_text_hover_color = '#F5C842'
define gui.choice_button_text_insensitive_color = '#4A3A2A7F'
