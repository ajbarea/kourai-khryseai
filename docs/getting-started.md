...
All ten agents (six specialists, two companion spirits, two quality
validators) plus the vn-bridge service and the observability stack
(Jaeger, Prometheus, Dozzle, memory-mcp, context7-mcp).
