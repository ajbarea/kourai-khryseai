...
Last reviewed: 2026-04-27 (M1 fully shipped + 5 Round 6 M6-future bullets closed (#34/#35/#36/#38) + research-driven ROADMAP additions (#37) + four OSS-CC lifts shipped (#39/#40/#41); 2026-04-27 live smoke pass uncovered + fixed two infrastructure bugs: forge worktree gitdir resolves from container [via second compose mount + safe.directory] (#42) and CLI input_required follow-up preserves forge tags [via send_and_stream forge_tags kwarg] (this PR); M7 scope grew the Message.metadata migration item informed by the v1.0 spec research; all the rest from the prior reviewed line still applies — see Shipped, revised M2/M7, and the M6 "Surfaced from external research" subsection)
